...
[source,c]
----
include::{sourcedir}/new_span.c[tag=new-span-snippet]
----
...
[source,c]
----
include::{sourcedir}/existing_span.c[tag=existing-span-snippet]
----
...
[source,c]
----
include::{sourcedir}/text_map.h[tag=text-map-snippet]
include::{sourcedir}/inject.c[tag=inject-snippet]
----
